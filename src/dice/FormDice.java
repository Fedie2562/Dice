...
public class FormDice extends javax.swing.JFrame {
    ...
    private void RollButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RollButtonActionPerformed
        die1Lable = Math.floor(Math.random()*(maxNum - minNum + 1)+ minNum);                                           
        die2Lable = Math.floor(Math.random()*(maxNum - minNum + 1)+ minNum);
        die1.setText(Math.round(die1Lable)+"");
        die2.setText(Math.round(die2Lable)+"");
        // I N S E R T      B I G     S L O W     L O A D I N G       B A R
